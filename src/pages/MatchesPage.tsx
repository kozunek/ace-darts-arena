          ...
          {upcoming.map((match) => (
            <div key={match.id} className="rounded-lg border border-border bg-card p-5 card-glow">
              <div className="flex items-center gap-2 text-xs text-muted-foreground mb-4">
                ...
                <Badge variant="outline" className="ml-auto text-accent border-accent/30 font-display text-[10px] uppercase">
                  Zaplanowany
                </Badge>
              </div>
            ...
            <div key={match.id} className="rounded-lg border border-border bg-card p-5 card-glow">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3 px-4">
                  ...
                  <span className={`text-3xl font-display font-bold ${(match.score2 ?? 0) > (match.score1 ?? 0) ? "text-secondary" : "text-muted-foreground"}`}>
                    {match.score2}
                  </span>
                </div>
